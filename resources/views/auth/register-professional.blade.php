...
<main class="flex min-h-screen flex-col lg:flex-row">
    ...
    <section class="flex flex-1 items-center justify-center p-6 sm:p-12 lg:w-1/2 xl:w-[45%] bg-white">
        <div class="w-full max-w-md">
            <div class="lg:hidden mb-8 text-center">
                <a href="{{ route('home') }}" class="inline-flex items-center gap-2">
                    <div class="w-8 h-8 bg-brand-orange rounded-sm flex items-center justify-center">
                        <div class="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <span class="text-xl font-extrabold text-brand-blue tracking-tight">GridSpace</span>
                </a>
            </div>
