                ...
                <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                        <div>
                            ...
                            <p class="text-gray-900">{{ $booking->listing->user->firstname }} {{ $booking->listing->user->lastname }}</p>
                        </div>
                        <div>
                            <span class="text-sm font-medium text-gray-500">Host Email:</span>
                            <p class="text-gray-900">
                                <a href="mailto:{{ $booking->listing->user->email }}" class="text-blue-600 hover:text-blue-900">
                                    {{ $booking->listing->user->email }}
                                </a>
                            </p>
                        </div>
                        <div>
                            <span class="text-sm font-medium text-gray-500">Host Phone:</span>
                            <p class="text-gray-900">
                                <a href="tel:{{ $booking->listing->user->phone }}" class="text-green-600 hover:text-green-900">
                                    {{ $booking->listing->user->phone }}
                                </a>
                            </p>
                        </div>
                    </div>
